...
TELLMEWHEN_ICONMENU_SHOWTIMER = "Set timer";
TELLMEWHEN_ICONMENU_SHOWTIMER_OFF = "Off";
TELLMEWHEN_ICONMENU_SHOWTIMER_CC = "Timer OmniCC";
TELLMEWHEN_ICONMENU_SHOWTIMER_TMW = "Timer TMW";
