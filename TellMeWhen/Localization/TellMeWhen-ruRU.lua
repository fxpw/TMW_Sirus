...
TELLMEWHEN_ICONMENU_CHOOSENAME = "Введите имя или id";
TELLMEWHEN_CHOOSENAME_DIALOG = "Введите имя или id заклинания / способности / предмета / баффа / дебаффа, который необходимо отслеживать. Вы можете добавить несколько идентификаторов, разделив их с помощью ;";
...
TELLMEWHEN_ICONMENU_WPNENCHANT = "Чары для оружия";
TELLMEWHEN_ICONMENU_TOTEM = "Тотем";

--TELLMEWHEN_ICONMENU_OPTIONS = "Больше настроек";

TELLMEWHEN_ICONMENU_COOLDOWNTYPE = "Тип кулдауна";
TELLMEWHEN_ICONMENU_SPELL = "Спелл или способность";
TELLMEWHEN_ICONMENU_ITEM = "Предмет";
TELLMEWHEN_ICONMENU_SHOWWHEN = "Показывать иконку";
TELLMEWHEN_ICONMENU_USABLE = "Юзабельно";
TELLMEWHEN_ICONMENU_UNUSABLE = "Не юзабельно";

TELLMEWHEN_ICONMENU_BUFFTYPE = "Бафф или дебаф ?";
TELLMEWHEN_ICONMENU_BUFF = "Бафф";
TELLMEWHEN_ICONMENU_DEBUFF = "Дебаф";
TELLMEWHEN_ICONMENU_UNIT = "За кем следить";
...
TELLMEWHEN_ICONMENU_BUFFSHOWWHEN = "Показывать бафф/дебафф";
TELLMEWHEN_ICONMENU_PRESENT = "Когда наложен";
TELLMEWHEN_ICONMENU_ABSENT = "Когда нету";
TELLMEWHEN_ICONMENU_ALWAYS = "Всегда";
TELLMEWHEN_ICONMENU_ONLYMINE = "Показывать только мои";
TELLMEWHEN_ICONMENU_SHOWTIMER = "Показывать таймер";

TELLMEWHEN_ICONMENU_WPNENCHANTTYPE = "Слот для оружия для наблюдения";
TELLMEWHEN_ICONMENU_MAINHAND = "Основная рука";
...
TELLMEWHEN_SPEC1 = "Спек 1"
TELLMEWHEN_SPEC2 = "Спек 2"
TELLMEWHEN_SPEC3 = "Спек 3"
TELLMEWHEN_SPEC4 = "Спек 4"
...
TELLMEWHEN_UIPANEL_TOOLTIP_ENABLEGROUP = "Показать и включить эту группу значков";
...
TELLMEWHEN_UIPANEL_TOOLTIP_SPEC1 = "Выберите для показа иконок в 1 спеке";
TELLMEWHEN_UIPANEL_TOOLTIP_SPEC2 = "Выберите для показа иконок в 2 спеке";
TELLMEWHEN_UIPANEL_TOOLTIP_SPEC3 = "Выберите для показа иконок в 3 спеке";
TELLMEWHEN_UIPANEL_TOOLTIP_SPEC4 = "Выберите для показа иконок в 4 спеке";
TELLMEWHEN_UIPANEL_SUBTEXT2 = 
[[Иконки работают в заблокированном состоянии.
В разблокированном вы можете настроить панель:
переместить, изменить размер и настроить значки
нажав ПКМ по пустому слоту. Вы также можете ввести
в чат /tmw, для переключения режима.]];
